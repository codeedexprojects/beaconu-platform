  ...
  return (
    <section className="px-4">
      ...
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-[17px] font-bold text-[#111827]">Universities</h2>
      ...
      >
        {universities.map((uni) => (
          <button
            key={uni.id}
            className="flex-shrink-0 bg-white rounded-2xl flex flex-col items-center justify-center gap-2 p-4 shadow-sm border border-gray-100"
            style={{ width: 132, minHeight: 108 }}
          >
            {/* Logo placeholder */}
            <div
