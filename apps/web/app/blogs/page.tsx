...
/* ─── Blog card — mirrors the College card layout ─────────────────────────── */
  ...
  return (
    ...
    >
      ...
      {blog.coverImageUrl ? (
        ...
        /* Cover placeholder */
        <div className="h-36 w-full bg-gradient-to-br from-[#FEF0EB] to-[#FDE8D8] flex items-center justify-center">
          <svg
            width="40"
            height="40"
            viewBox="0 0 24 24"
      ...
      {/* Card body */}
      <div className="p-4">
        {/* Author avatar + meta row */}
        <div className="flex items-center gap-2.5 mb-3">
          {/* Author initials avatar */}
          <div className="w-8 h-8 rounded-full bg-[#FEF0EB] border-2 border-white ring-1 ring-[#E8521A]/20 flex items-center justify-center shrink-0">
        ...
        {/* CTA — mirrors "View Details →" button */}
        <div className="w-full h-11 rounded-full bg-[#E8521A] flex items-center justify-center gap-2 text-white text-[14px] font-semibold group-hover:bg-[#D04718] transition-colors">
          Read Article
          <svg
            width="15"
            height="15"
