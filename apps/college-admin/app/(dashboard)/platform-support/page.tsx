...
import { usePlatformTickets } from "@/hooks/use-platform-tickets";
import type { PlatformTicketStatus } from "@beaconu/types";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-border pb-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Raise a query or request a call back from the BeaconU platform team.
          </p>
        </div>
        <Button
          className="gap-2"
          onClick={() => router.push("/platform-support/new")}
        >
