...
function CourseQuotasTabContent({ courseId }: { courseId: string }) {
...
export default function SetupAcademicsPage() {
  ...
  const handleDelete = (course: { id: string; name: string }) => {
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-2 pt-4 justify-end">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          handleDelete({ id: course.id, name: course.name })
                        }
                      >
                        Delete
                      </Button>
            ...
            {activeTab !== "basic" && editingCourse && (
              <Card className="border border-border/80 shadow-md bg-card/60 backdrop-blur-md">
                ...
                <CardContent className="space-y-6 min-h-[300px]">
                  {activeTab === "course_quotas" ? (
                    <CourseQuotasTabContent courseId={editingCourse.id} />
                  ) : isLoadingTabs ? (
                    <div className="flex h-48 items-center justify-center">
                      <Loader2 className="h-8 w-8 animate-spin text-primary" />
                    </div>
                        ...
                        <div className="space-y-4">
                          ...
                          {(getActiveTabPayload().alliances || []).map(
                            (a: any, idx: number) => {
                              ...
                              const focusAreas =
                                a.details?.key_focus_areas || [];
                              const legalDocs =
                                a.details?.legal_documents || [];
                              const activities =
                                a.details?.alliance_activities?.activities ||
                                [];
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <Textarea
                                    ...
                                    value={
                                      a.details?.collaboration_impact || ""
                                    }
                                    onChange={(e) =>
                                      updateDetails({
                                ...
                                >
                                  <div className="flex gap-2 items-center">
                                    ...
                                    <Input
                                      ...
                                      value={item.percent ?? ""}
                                      onChange={(e) =>
                                        updateWe({ percent: e.target.value })
                                      }
                                    />
                                    <Button
                                      type="button"
                                  ...
                                  <Input
                                    ...
                                    value={item.subtitle || ""}
                                    onChange={(e) =>
                                      updateWe({ subtitle: e.target.value })
                                    }
                                  />
                                  <Input
