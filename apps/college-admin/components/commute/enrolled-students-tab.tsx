...
export function EnrolledStudentsTab() {
  ...
  const { data: routes = [] } = useCollegeCommutes();
  const { data, isLoading } = useCollegeCommuteEnrollments({
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableRow>
                ...
                >
                  No students have taken commute yet.
                </TableCell>
              </TableRow>
            ) : (
              enrollments.map((enrollment) => (
                ...
                >
                  ...
                  <TableCell>
                    <div>{enrollment.bus.busNumber}</div>
                  ...
                  <TableCell>
                    <div>{enrollment.pickupStop.stopName}</div>
