          ...
          {step === 'email' ? (
            <>
              <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-white leading-tight">Sign in</h2>
                  <p className="text-xs text-white/40">We'll send a one-time code to your email</p>
                </div>
              </div>
            ...
            <>
              <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-white leading-tight">Enter OTP</h2>
