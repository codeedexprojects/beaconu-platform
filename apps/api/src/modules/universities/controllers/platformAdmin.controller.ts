...
export class UniversityTypePlatformAdminController {
	static async listAll(req: Request, res: Response, next: NextFunction) {
		try {
			...
			return res
				.status(200)
				.json(ApiResponse.success("University types fetched successfully", types));
		} catch (error) {
			next(error);
		}
	}
	...
	static async getById(req: Request, res: Response, next: NextFunction) {
		try {
			...
			return res
				.status(200)
				.json(ApiResponse.success("University type fetched successfully", type));
		} catch (error) {
			next(error);
		}
	}
	...
	static async create(req: Request, res: Response, next: NextFunction) {
		try {
			...
			return res
				.status(201)
				.json(ApiResponse.success("University type created successfully", type));
		} catch (error) {
			next(error);
		}
	}
	...
	static async update(req: Request, res: Response, next: NextFunction) {
		try {
			...
			const type = await UniversityTypePlatformAdminService.update(params.id, data);
			return res
				.status(200)
				.json(ApiResponse.success("University type updated successfully", type));
		} catch (error) {
			next(error);
		}
	}
	...
	static async disable(req: Request, res: Response, next: NextFunction) {
		try {
			...
			return res
				.status(200)
				.json(ApiResponse.success("University type disabled successfully", type));
		} catch (error) {
			next(error);
		}
	}
	...
	static async remove(req: Request, res: Response, next: NextFunction) {
		try {
			...
			return res
				.status(200)
				.json(ApiResponse.success("University type deleted successfully", null));
		} catch (error) {
			next(error);
		}
	}
