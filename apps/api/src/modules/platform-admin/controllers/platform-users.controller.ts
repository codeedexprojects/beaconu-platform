...
export class PlatformUsersController {
  static async getAllProfiles(_req: Request, res: Response) {
  ...
  static async updateBlinkUserStatus(req: Request, res: Response) {
  ...
  static async getPendingBlinkUsers(_req: Request, res: Response) {
