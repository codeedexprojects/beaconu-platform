...
export class CounsellingPlatformAdminController {
  ...
  static async getById(req: Request, res: Response, next: NextFunction) {
    try {
      const counsellor = await CounsellingService.getById(req.params['id'] as string);
  ...
  static async updateStatus(req: Request, res: Response, next: NextFunction) {
    try {
      const counsellor = await CounsellingService.updateStatus(req.params['id'] as string, req.body);
