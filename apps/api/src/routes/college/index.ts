...
import collegeAdminLegalDocumentRoutes from "@/modules/content/routes/legal-documents-college-admin.routes";
...
router.use("/legal-documents", collegeAdminLegalDocumentRoutes);
